...
| **1 новое заклинание** | Если есть доступ к магии (профессия, обучение). Нужно знать родительское заклинание в ветке. |
| **Рост ОМ** | ОМ = Разум × 2 + уровень × 3 — автоматически увеличивается с уровнем. |

### Сводка по уровням

| Уровень | Атрибут | Навыки | Талант | Заклинание |
|---------|---------|--------|--------|------------|
| 2 | +1 | 2 очка | +1 | +1 (если маг) |
| 3 | +1 | 2 очка | — | +1 |
| 4 | +1 | 2 очка | +1 | +1 |
| 5 | +1 | 2 очка | — | +1 |
| 6 | +1 | 2 очка | +1 | +1 |
...
|----------|-----|------------|
| **Навык «Точный выстрел»** | +3 | Только дальний бой |
| **Навык «Пробивающий выстрел»** | +5 | Заменяет Точный выстрел, только дальний бой |
