...
## Кость истории на проверках навыков

В **ответственных моментах** (кража, взлом, переговоры, обман, скрытное проникновение и т.п.) Кость истории влияет на проверки навыков так же, как на атаки и заклинания. Срабатывает **только при дубле** на двух обычных кубиках.

### Последствия (Кость истории 1 при дубле)

Даже при успешной проверке что-то идёт не так. Мастер выбирает или импровизирует по ситуации:

| Пример | Эффект |
|--------|--------|
| **Скрытность** | Тебя заметили, сработала сигнализация, наступил на скрипучую доску |
| **Взлом** | Сработала ловушка, замок заклинило, кто-то услышал |
| **Обман/Убеждение** | Собеседник заподозрил неладное, подслушал третье лицо |
| **Знания** | Информация неполная или вводит в заблуждение |
| **Общее** | Дополнительная сложность, свидетели, следы, потеря времени |

При **провале** проверки последствие усиливается — мастер может комбинировать эффекты.

### Бонусы (Кость истории 5 или 6 при дубле)

При успехе — дополнительный положительный эффект. Мастер выбирает по контексту:

| Пример | Эффект |
|--------|--------|
| **Скрытность** | Попутно украл что-то ещё, заметил тайник или слабое место |
| **Взлом** | Обнаружил спрятанный предмет, обезвредил заодно другую ловушку |
| **Обман/Убеждение** | Собеседник выдал лишнюю информацию, дал скидку или услугу |
| **Знания** | Вспомнил связанный факт, нашёл дополнительную подсказку |
| **Общее** | Сделал что-то сверх задачи, получил неожиданное преимущество |

**5** — небольшой бонус (подсказка, мелкая выгода). **6** — значительный (дополнительная цель достигнута, важная информация, серьёзное преимущество).
